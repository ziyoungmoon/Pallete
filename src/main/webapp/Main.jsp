...
<% 
	...
	List<Member> rankingList = (List<Member>)request.getAttribute("rankingList");
...
<body>
   ...
   <a class="mentoringList">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;월간 멘토 랭킹</a>
   <br><br>
   
   <sapn class='mentoringLank'>
<%	
    if (rankingList != null) {   
     
     Iterator<Member> memIter = rankingList.iterator();
     
     int i = 0;
     while ( memIter.hasNext() ) {
      
      Member mem = (Member)memIter.next();
      images[i] = mem.getImage();
      String src;
      ...
      if(images[i] != null) {
        src = '/' + "upload" + '/' + images[i];
    	  ...
    	  src = '/' + "images" + '/' + "melody.jpeg";
      }
%>         
 		
      <span class = 'box1'>
         <span class = 'num1'><%=i+1 %></span>
         <%-- <span><img class='photo1' src="<c:url value='/images/melody.jpeg' />" /></span> --%>
         <%-- <img src="<c:url value='/upload/${mem.image}'/>" width="300px" height="300px"/> --%>
         <img src="<c:url value='<%=src %>'/>" width="145px" height="140px"/>
         <span class='name1'><%=mem.getName()%></span>
         <span class='part1'><%=mem.getPart()%></span>
         <span class='score'><%=mem.getScore()%>/5.0</span>
      </span>
   </span>
